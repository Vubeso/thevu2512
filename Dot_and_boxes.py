...
dot_color = 'green'
player1_color = 'blue'
player1_color_light = 'blue'
player2_color = 'red'
player2_color_light = 'red'
Green_color = 'Black'
...
class Dots_and_Boxes():
    # Initialization functions:Hàm khởi tạo
    def __init__(self):
        self.window = Tk()
    ...
    # Input from user in form of clicks: Đầu vào từ người dùng
    ...
    # The modules required to carry out game logic: Các modules cần thiết để thực hiện trò chơi
    # ------------------------------------------------------------------
...
# ------------------------------------------------------------------
#Drawing Functions: Chức năng vẽ
#The modules required to draw required game based object on canvas: Các modules cần thiết để vẽ đối tượng dựa trên trò chơi
